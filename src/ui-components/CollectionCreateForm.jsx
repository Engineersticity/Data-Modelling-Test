...
export default function CollectionCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCurrentTagsValue("");
    setRepresentativeId(initialValues.representativeId);
    setErrors({});
  };
  ...
  const validations = {
    tags: [],
    representativeId: [{ type: "Required" }],
  };
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.representativeId ?? value;
          }
          if (errors.representativeId?.hasError) {
            runValidationTasks("representativeId", value);
          }
          setRepresentativeId(value);
        }}
        onBlur={() => runValidationTasks("representativeId", representativeId)}
        errorMessage={errors.representativeId?.errorMessage}
        hasError={errors.representativeId?.hasError}
        {...getOverrideProps(overrides, "representativeId")}
      ></TextField>
      <Flex
